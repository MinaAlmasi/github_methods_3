...
print(np.mean(scores_log_1e5))
print(np.mean(scores_log_1e1))
print(np.mean(scores_log_1e_neg5))


```

The model with the lowest C has the highest accuracy (0.596) meaning that introducing penalty improves prediction accuracy.  
