...
```{r 1.1}
df <- read_bulk(directory = "/Users/minaalmasi/Documents/Cognitive_Science/Methods_3/methods3_code/github_methods_3/week_03/experiment_2")
```
...
_obj.resp_: 
The participant's answer (coded as "o" = odd and "e" = even). 
