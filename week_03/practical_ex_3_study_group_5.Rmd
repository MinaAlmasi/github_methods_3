...
It seems, that response time only significantly increases when task (i.e. cue type) goes from 'singles' to 'pairs'. The estimate of the quadruplet cue type is very low, with a large standard error and therefore a large p-value.
...
#Table 
tibble("model"=c("Correct Model 1","Correct Model 2", "Correct Model 3", "Correct Model 4"), "residual variance"=c(rvar_model1, rvar_model2, rvar_model3, rvar_model4), "residual sd"=c(sd_model1, sd_model2, sd_model3, sd_model4), "AIC"=c(AICs[1,2], AICs[2,2], AICs[3,2], AICs[4,2]))
```
