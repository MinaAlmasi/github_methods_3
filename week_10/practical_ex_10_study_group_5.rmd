...
eigs = zip(np.abs(eigval), eigvec)

## SORT the zipped list ##
eigs_sorted = sorted(eigs)


## RETURN the zipped list to their individual lists 
eigs_tuple = zip(*eigs_sorted)

eigval, eigvec = [list(tuple) for tuple in eigs_tuple]
