...
```{python}
eigenvalues = eig[0].real #first array, real numbers
eigenvectors = eig[1].real #second array, real numbers
...
```{python}
sort_eigenvalues = sorted(np.abs(eigenvalues))
sort_eigenvalues

#sort_eigenvectors = sorted(eigenvectors)
