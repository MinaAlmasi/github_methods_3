...
author: 'Mina Almasi, Daniel Blumenkranz, Anton Drasbæk Schiønning, Matilde Just Sterup'
date: "7/12/21"
...
The proportion correctly classified completely stagnates by adding the last 5 principle components. They essentially do not make the model better. This is due to the fact that they are the noise dimensions hence it would make sense that they do not improve the model.
