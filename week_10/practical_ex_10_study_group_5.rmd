...
eigval_inds = eigval_abs.argsort()

## SORTING the eigenvalues with sorted() ## 
eigval_sorted = sorted(eigval_abs)

## SORTING the eigenvectors using the indices ## 
eigvec_sorted = eigvec[eigval_inds]
```
